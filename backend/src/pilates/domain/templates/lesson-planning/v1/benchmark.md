...
**Outcome:** 75.5% (generated: 4.03, target: 5.33)

## Muscle group coverage
Percentage of exercise reps whose primary muscle group matches requirements.
...
**Outcome:** Balance score: 86.6 (warm-up: 13.5%, main: 73.3%, cool-down: 13.2%)
...
**Outcome:** 78.7% (59/75 transitions require position change)
...
**Outcome:** Progressive: Yes (regressions: 1, trajectory: [4.50, 4.59, 5.37, 4.33, 4.48, 3.16])

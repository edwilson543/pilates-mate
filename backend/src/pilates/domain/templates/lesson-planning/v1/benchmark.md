...
**Outcome:** 78.6% (generated: 4.19, target: 5.33)
...
**Outcome:** Correlation: 1.00 (warm-up: 13.1%, main: 74.4%, cool-down: 12.4%)
...
**Outcome:** 78.5% (62/79 transitions require position change)
...
**Outcome:** Progressive: Yes (regressions: 1, trajectory: [4.60, 5.10, 4.77, 5.52, 4.54, 2.51])
